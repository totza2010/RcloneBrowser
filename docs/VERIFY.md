...
#### บล็อก 4 · เดินดูไฟล์ใน remote

| # | ทำอะไร | บรรทัดที่ต้องเห็น | ผล | ผู้ทดสอบ / วันที่ |
|---|---|---|---|---|
| 4.1 | เปิดแท็บ remote | `rb.remote: reading path=` | ⬜ | |
| 4.2 | เข้าโฟลเดอร์ย่อย | `rb.remote: reading path=` ที่ลึกลงไป | ⬜ | |
| 4.3 | โฟลเดอร์ที่เข้าไม่ได้ | `rb.remote: failed path= reason=` | ⬜ | |
| 4.4 | ชื่อไฟล์ภาษาไทย / อักขระพิเศษ | ชื่อไม่เพี้ยนใน log และบนจอ | ⬜ | |
| 4.5 | เปิดโฟลเดอร์ที่มีไฟล์เกิน 10,000 | ไม่ค้าง และ log ไม่ท่วม | ⬜ | |
