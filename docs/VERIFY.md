...
#### ทั้งระบบ · ทดสอบปิดท้ายเมื่อครบทุกบล็อก
...
| 6.3 | `python scripts/check_layers.py` | ไฟล์ปลอด GUI ต้องมากกว่า 62/105 อย่างมีนัย | ⬜ | |
| 6.4 | ปิดหน้าต่างทั้งหมด รันด้วย `--run-task` อย่างเดียว | ตารางเวลา คิว งาน ประวัติ script ทำงานครบ | ⬜ | |
