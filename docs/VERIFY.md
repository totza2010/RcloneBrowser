...
| # | ทำอะไร | บรรทัดที่ต้องเห็น | ผล | ผู้ทดสอบ / วันที่ |
|---|---|---|---|---|
| 2.1 | เปิดโปรแกรม | `rb.remote: listing remotes` แล้ว `rb.remote: found n=` | ⬜ | |
| 2.2 | เพิ่ม remote ใน rclone config แล้วกด refresh | `found n=` เพิ่มขึ้นหนึ่ง | ⬜ | |
| 2.3 | ตั้ง path rclone ผิด | `rb.remote: refused` พร้อมเหตุผล | ⬜ | |
| 2.4 | remote ที่มี `:` ในชื่อ | ชื่อไม่ถูกตัด (ครอบด้วย `test_remote_registry` แล้ว) | ⬜ | |
| 2.5 | เปิดโปรแกรม | `rb.app: rclone version` | ⬜ | |
